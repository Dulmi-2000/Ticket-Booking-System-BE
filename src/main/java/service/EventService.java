...
public class EventService {
    ...
    @Transactional
    public boolean decrementAvailableTickets(Long eventId, int quantity) {
        Event event = getEventById(eventId);
        if (event.getAvailableTickets() < quantity) return false;
    ...
    @Transactional
    public void incrementAvailableTickets(Long eventId, int quantity) {
        Event event = getEventById(eventId);
        event.setAvailableTickets(event.getAvailableTickets() + quantity);
        eventRepository.save(event);
    }
